...
import com.chisto.example.springboot.web.inydep.services.ServicioPrueba;
...
public class IndexController {
	...
	@Autowired
	private ServicioPrueba servicio;
	...
	public String testPruebaSencilla(Model model){
		model.addAttribute("texto_prueba", servicio.pruebaSencilla());
		return "pruebas";
	}
	
	@GetMapping("/pruebaCompleja")
	public String testPruebaCompleja(Model model){
		model.addAttribute("texto_prueba", servicio.pruebaComleja());
		return "pruebas";
	}
